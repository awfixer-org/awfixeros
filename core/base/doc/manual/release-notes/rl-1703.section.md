...
- Nixpkgs is now extensible through overlays. See the [Nixpkgs manual](https://awos.org/nixpkgs/manual/#sec-overlays-install) for more information.
...
- The `overridePackages` function has been rewritten to be replaced by [ overlays](https://awos.org/nixpkgs/manual/#sec-overlays-install)

- Packages in nixpkgs can be marked as insecure through listed vulnerabilities. See the [Nixpkgs manual](https://awos.org/nixpkgs/manual/#sec-allow-insecure) for more information.
...
- `overridePackages` function no longer exists. It is replaced by [ overlays](https://awos.org/nixpkgs/manual/#sec-overlays-install). For example, the following code:
