...
If you run `awos-rebuild switch`, the container will be built. If the
...
container in `/var/lib/awos-containers`. Containers can be destroyed using
the imperative method: `awos-container destroy foo`.
