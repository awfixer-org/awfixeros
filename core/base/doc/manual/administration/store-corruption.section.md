...
replace un-synced files with zero bytes.) awos tries hard to prevent
...
If the corruption is in a path in the closure of the awos system
configuration, you can fix it by doing

```ShellSession
# awos-rebuild switch --repair
```
