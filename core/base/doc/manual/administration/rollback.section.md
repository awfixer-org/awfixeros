...
After running `awos-rebuild` to switch to a new configuration, you may
...
can be found under the GRUB submenu "awos - All configurations". This
...
where `N` is the number of the awos system configuration. To get a
list of the available configurations, do:

```ShellSession
$ ls -l /nix/var/nix/profiles/system-*-link
...
lrwxrwxrwx 1 root root 78 Aug 12 13:54 /nix/var/nix/profiles/system-268-link -> /nix/store/202b...-awos-13.07pre4932_5a676e4-4be1055
```
