...
awos supports file systems that are encrypted using *LUKS* (Linux
...
`awos-generate-config`, but you might want to verify that your
...
awos also supports unlocking your LUKS-Encrypted file system using a FIDO2
compatible token.
