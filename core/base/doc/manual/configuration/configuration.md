...
This chapter describes how to configure various aspects of a awos machine through the configuration file {file}`/etc/awos/configuration.nix`. As described in [](#sec-changing-config), changes to this file only take effect after you run {command}`awos-rebuild`.
