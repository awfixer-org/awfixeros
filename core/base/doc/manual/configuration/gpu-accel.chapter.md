...
awos provides various APIs that benefit from GPU hardware acceleration,
...
the OpenCL driver for a particular GPU family. In awos, there are two
...
different GPUs. In awos, there are two ways to make ICD files visible
