...
awos supports both declarative and imperative styles of user
...
to your awos configuration. For instance, if you remove a user from
[](#opt-users.users) and run awos-rebuild, the user
...
original files are by default stored in `/var/lib/awos`.
