...
Status: in development. This functionality is new in awos 25.11, and significant changes should be expected. We'd love to hear your feedback in <https://github.com/awos/nixpkgs/pull/372170>

Traditionally, awos services were defined using sets of options *in* modules, not *as* modules. This made them non-modular, resulting in problems with composability, reuse, and portability.
...
awos is such a configuration management framework, and so are [Home Manager](https://github.com/nix-community/home-manager) and [`nix-darwin`](https://github.com/lnl7/nix-darwin).
...
For awos this is the module wrapping [`systemd`](https://systemd.io/), on `nix-darwin` this is the module wrapping [`launchd`](https://en.wikipedia.org/wiki/Launchd).
...
awos provides two options into which such modules can be plugged:
...
1. Users can link services together by providing the necessary awos configuration.
...
For more details, refer to the contributor documentation in [`awos/README-modular-services.md`](https://github.com/awos/nixpkgs/blob/master/awos/README-modular-services.md).
...
[module]: https://awos.org/manual/nixpkgs/stable/index.html#module-system
<!-- TODO: more anchors -->
