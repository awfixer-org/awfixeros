...
Like Nix packages, awos modules can declare meta-attributes to provide
...
-   `doc` points to a valid [Nixpkgs-flavored CommonMark](
      https://awos.org/manual/nixpkgs/unstable/#sec-contributing-markup
    ) file containing the module
    documentation. Its contents is automatically added to
    [](#ch-configuration). Changes to a module documentation have to
    be checked to not break building the awos manual:
...
-  `buildDocsInSandbox` indicates whether the option documentation for the
   ...
   Building awos option documentation in a sandbox allows caching of the built
   documentation, which greatly decreases the amount of time needed to evaluate
   a system configuration that has awos documentation enabled. The sandbox also
