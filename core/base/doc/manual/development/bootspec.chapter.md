...
Bootspec is a feature introduced in [RFC-0125](https://github.com/awos/rfcs/pull/125) in order to standardize bootloader support and advanced boot workflows such as SecureBoot and potentially more.
The reference implementation can be found [here](https://github.com/awos/nixpkgs/pull/172237).
