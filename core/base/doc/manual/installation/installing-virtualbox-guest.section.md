...
Installing awos into a VirtualBox guest is convenient for users who
want to try awos without installing it on bare metal. If you want to set
...
1.  Mount the CD-ROM with the awos ISO (by clicking on CD/DVD-ROM)
...
`/etc/awos/configuration.nix` to auto-mount them. If you do not add
