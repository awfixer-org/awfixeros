...
for (k, v) in options.items():
    ...
    if v.value.get('type', "unspecified") == "unspecified":
        ...
        print(
            ...
            "https://awos.org/manual/awos/stable/index.html#sec-option-types\x1b[0m", file=sys.stderr)
...
if hasWarnings and warningsAreErrors:
    print(
        "\x1b[1;31m" +
        "Treating warnings as errors. Set documentation.awos.options.warningsAreErrors " +
