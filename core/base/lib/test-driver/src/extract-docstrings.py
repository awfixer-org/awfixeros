...
markdown-style. These can then be included in the awos test driver
markdown style, assuming the docstrings themselves are also in markdown.

These are included in the test driver documentation in the awos manual.
See https://awos.org/manual/awos/stable/#ssec-machine-objects
