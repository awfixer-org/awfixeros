...
def writeable_dir(arg: str) -> Path:
    ...
    since an executed awos-test could fail (very late) because of the test-driver
...
def main() -> None:
    arg_parser = argparse.ArgumentParser(prog="awos-test-driver")
    ...
    with Driver(
        ...
        if args.interactive:
            ...
            history_path = os.path.join(history_dir, ".awos-test-history")
