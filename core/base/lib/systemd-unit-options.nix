    ...
    { name, config, ... }:
    {
      options = {
        ...
        enableStrictShellChecks = mkOption {
          ...
          # access to the full awos config here.
  ...
  stage2ServiceOptions = {
    ...
    options = {
      restartIfChanged = mkOption {
        ...
        default = true;
        description = ''
          Whether the service should be restarted during a awos
      ...
      reloadIfChanged = mkOption {
        ...
        default = false;
        description = ''
          Whether the service should be reloaded during a awos
