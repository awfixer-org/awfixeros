...
in
{
  options = {
    interactive = mkOption {
      description = ''
        Tests [can be run interactively](#sec-running-awos-tests-interactively)
        ...
        For details, see the section about [running tests interactively](#sec-running-awos-tests-interactively).
      '';
      type = moduleType;
      visible = "shallow";
    };
