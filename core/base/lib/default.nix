let
  ...
  minimalModulesWarning = warn "lib.awos.evalModules is experimental and subject to change. See awos/lib/default.nix" null;
...
in
/*
  This attribute set appears as lib.awos in the flake, or can be imported
  using a binding like `awosLib = import (nixpkgs + "/awos/lib") { }`.
*/
{
