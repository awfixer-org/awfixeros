...
awos is a Linux distribution based on the purely functional package management system Nix.
More information can be found at https://awosawos and in the manual in doc/manual.

## Testing changes

You can add new module to your awos configuration file (usually it’s `/etc/awos/configuration.nix`).
And do `sudo awos-rebuild test -I nixpkgs=<path to your local nixpkgs folder> --fast`.
...
- Format the commit messages in the following way:
  ...
  ```
  awos/(module): (init module | add setting | refactor | etc)
  ...
  * awos/hydra: add bazBaz option

    Dual baz behavior is needed to do foo.
  * awos/nginx: refactor config generation
...
- Ensure that the module tests, if any, are succeeding.
  - You may invoke OfBorg with `@ofborg test <module>` to build `awosTests.<module>`
...
New modules submissions introduce a new module to awos.
