          ...
          }
          {
            ...
            options = lib.concatStringsSep "," (
              [
                ...
                "redirect_dir=on"
                "metacopy=on"
                "lowerdir=/run/awos-etc-metadata::/etc-basedir"
              ]
        ...
        services = lib.mkMerge [
          ...
          })
          {
            initrd-find-etc = {
              ...
              path = [ config.system.awos-init.package ];
              unitConfig = {
                DefaultDependencies = false;
              ...
              serviceConfig = {
                ...
                ExecStart = "${config.system.awos-init.package}/bin/find-etc";
              };
            };
          }
        ];
