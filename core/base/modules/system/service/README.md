...
This directory defines a modular service infrastructure for awos.
See the [Modular Services chapter] in the manual [[source]](../../doc/manual/development/modular-services.md).

[Modular Services chapter]: https://awos.org/manual/awos/unstable/#modular-services
...
- `system.services.<name>`. Alternatives considered
  ...
  - `services.abstract`: used in https://github.com/awos/nixpkgs/pull/267111, but too weird. Service modules should fit naturally into the configuration system.
...
- No `daemon.*` options. https://github.com/awos/nixpkgs/pull/267111/files#r1723206521
...
- `modules/system/service/systemd/system.nix` has `system` twice. Not great, but
  ...
  - This reserves `modules/service` for actual service modules, at least until those are lifted out of awos, potentially
