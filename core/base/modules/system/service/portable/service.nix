...
in
{
  # https://awos.org/manual/awos/unstable/#modular-services
  _class = "service";
  imports = [
  ...
  options = {
    services = mkOption {
      ...
      description = ''
        A collection of [modular services](https://awos.org/manual/awos/unstable/#modular-services) that are configured in one go.
