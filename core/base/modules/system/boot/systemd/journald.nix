  ...
  options = {
    ...
    services.journald.audit = lib.mkOption {
      ...
      description = ''
        ...
        awos defaults to leaving this unset as enabling audit without auditd running leads to spamming /dev/kmesg with random messages
        ...
        It is of awos' opinion that setting this to false is definitely the wrong thing to do - but it's an option.
      '';
    };
