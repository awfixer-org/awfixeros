...
in
{
  ...
  config = {
    ...
    systemd.tmpfiles.packages = [
      ...
      (pkgs.writeTextFile {
        name = "awos-tmpfiles.d";
        destination = "/lib/tmpfiles.d/00-awos.conf";
        text = ''
    ...
    boot.initrd.systemd = {
      ...
      # sets up files under the prefix /sysroot, after the hierarchy is available and before awos activation
