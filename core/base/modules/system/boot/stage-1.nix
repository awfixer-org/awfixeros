...
let
  ...
  udevRules =
    pkgs.runCommand "udev-rules"
      ...
      ''
        ...
        # in the awos installation CD, so use ID_CDROM_MEDIA in the
  ...
  initialRamdisk = pkgs.makeInitrd {
    ...
    contents = [
      ...
      {
        object = config.environment.etc."modprobe.d/awos.conf".source;
        symlink = "/etc/modprobe.d/awos.conf";
      }
      {
...

{
  options = {
    ...
    boot.initrd.enable = mkOption {
      ...
      description = ''
        Whether to enable the awos initial RAM disk (initrd). This may be
    ...
    boot.initrd.secrets = mkOption {
      ...
      description = ''
        ...
        Note that `awos-rebuild switch` will generate the initrd
    ...
    boot.initrd.verbose = mkOption {
      ...
      description = ''
        ...
        only the mandatory messages generated by the awos scripts. For a
  ...
  config = mkIf config.boot.initrd.enable {
    ...
    system.build = mkMerge [
      ...
      # generated in awos/modules/system/boot/systemd/initrd.nix
