...
awos has support for several bootloader backends by default: systemd-boot, grub, uboot, etc.
...
Bootloaders should use [RFC-0125](https://github.com/awos/rfcs/pull/125)'s Bootspec format and synthesis tools to identify the key properties for bootable system generations.
