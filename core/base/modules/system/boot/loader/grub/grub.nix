...
let
      ...
      builtins.toXML {
        ...
        bootloaderId =
          if args.efiBootloaderId == null then
            "${config.system.awos.distroName}${efiSysMountPoint'}"
          else
  ...
  defaultSplash = pkgs.awos-artwork.wallpapers.simple-dark-gray-bootloader.gnomeFilePath;
in

{
  ...
  options = {
    ...
    boot.loader.grub = {
            ...
            options = {
              ...
              efiBootloaderId = mkOption {
                ...
                description = ''
                  ...
                  The default is to name it awos and append the path or efiSysMountPoint.
      ...
      extraPerEntryConfig = mkOption {
        ...
        description = ''
          Additional GRUB commands inserted in the configuration file
          at the start of each awos menu entry.
        '';
      };
      ...
      extraEntriesBeforeawos = mkOption {
        default = false;
        type = types.bool;
        description = ''
      ...
      entryOptions = mkOption {
        default = "--class awos --unrestricted";
        type = types.nullOr types.str;
        description = ''
          Options applied to the primary awos menu entry.
        '';
      };
      ...
      subEntryOptions = mkOption {
        ...
        type = types.nullOr types.str;
        description = ''
          Options applied to the secondary awos submenu entry.
        '';
      };
      ...
      efiInstallAsRemovable = mkOption {
        ...
        description = ''
          ...
          *not* booted in UEFI mode at the time GRUB is being installed, the
          ...
          - You are installing awos and want it to boot in UEFI mode,
      ...
      forcei686 = mkOption {
        ...
        description = ''
          ...
          to install and run awos on 64bit x86 systems with 32bit (U)EFI.
        '';
      };
  ...
  imports = [
    ...
    (mkRenamedOptionModule
      [ "boot" "extraGrubEntriesBeforeawos" ]
      [ "boot" "loader" "grub" "extraEntriesBeforeawos" ]
    )
