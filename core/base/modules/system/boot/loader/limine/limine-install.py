...
def bootjson_to_bootspec(bootjson: dict) -> BootSpec:
    specialisations = bootjson['org.awos.specialisation.v1']
...
def generate_xen_efi_files(
    ...
    Arguments:
    bootspec -- the awos BootSpec requiring Xen EFI configuration
...
def xen_config_entry(
    ...
    bootspec -- The awos BootSpec used for generating this Limine configuration
