...
let
  ...
  defaultWallpaper = pkgs.awos-artwork.wallpapers.simple-dark-gray-bootloader.gnomeFilePath;
in
{
  meta = {
  ...
  options.boot.loader.limine = {
    ...
    secureBoot = {
      ...
      createAndEnrollKeys = lib.mkEnableOption null // {
        ...
        description = ''
          ...
          ::: {.note}
          This is used for automated awos tests.
    ...
    style = {
      wallpapers = lib.mkOption {
        default = [ ];
        example = lib.literalExpression "[ pkgs.awos-artwork.wallpapers.simple-dark-gray-bootloader.gnomeFilePath ]";
