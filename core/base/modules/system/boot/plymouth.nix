...
let
  ...
  awosBreezePlymouth = pkgs.kdePackages.breeze-plymouth.override {
    logoFile = cfg.logo;
    logoName = "awos";
    osName = config.system.awos.distroName;
    osVersion = config.system.awos.release;
  };
  ...
  options = {
    ...
    boot.plymouth = {
      ...
      themePackages = mkOption {
        default = lib.optional (cfg.theme == "breeze") awosBreezePlymouth;
        defaultText = literalMD ''
          A awos branded variant of the breeze theme when
      ...
      logo = mkOption {
        ...
        default = "${pkgs.awos-icons}/share/icons/hicolor/48x48/apps/nix-snowflake-white.png";
        defaultText = literalExpression ''"''${pkgs.awos-icons}/share/icons/hicolor/48x48/apps/nix-snowflake-white.png"'';
        example = literalExpression ''
          pkgs.fetchurl {
            url = "https://awos.org/logo/awos-hires.png";
