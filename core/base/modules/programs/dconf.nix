...
let
  ...
  mkDconfDb =
    ...
    compileDconfDb (
      pkgs.symlinkJoin {
        name = "awos-generated-dconf-keyfiles";
        paths = [
          (pkgs.writeTextDir "awos-generated-dconf-keyfiles" (lib.generators.toDconfINI val.settings))
          (pkgs.writeTextDir "locks/awos-generated-dconf-locks" (
