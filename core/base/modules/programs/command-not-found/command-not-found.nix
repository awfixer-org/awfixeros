...

{
  options.programs.command-not-found = {
    ...
    dbPath = lib.mkOption {
      default = "/nix/var/nix/profiles/per-user/root/channels/awos/programs.sqlite";
      description = ''
  ...
  config = lib.mkIf cfg.enable {
    ...
    # NOTE: Fish by itself checks for awos command-not-found, let's instead makes it explicit.
