...
let
  ...
  pamOpts =
    ...
    in
    {
      ...
      # awos/tests/pam/pam-file-contents.nix. Please update tests there when
          ...
          in
          {
            ...
            auth = autoOrderRules (
              ...
              ++
                ...
                # pam_unix is marked as 'sufficient' on awos which means nothing will run
    ...
    security.pam.sshAgentAuth = {
      ...
      authorizedKeysFiles = lib.mkOption {
        ...
        description = ''
          ...
          See [issue #31611](https://github.com/awos/nixpkgs/issues/31611)
          :::
        '';
    ...
    warnings =
      lib.optional
        ...
        ''
          ...
          See https://github.com/awos/nixpkgs/issues/31611
        ''
      ++
        lib.optional
          (
