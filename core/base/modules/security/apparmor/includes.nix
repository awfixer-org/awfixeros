...
in
{
  ...
  config.security.apparmor.includes = {
    ...
    "abstractions/dri-common" = ''
      ...
      ${etcRule "drirc"}
    '';
    # The config.fonts.fontconfig awos module adds many files to /etc/fonts/
    # by symlinking them but without exporting them outside of its awos module,
    ...
    "abstractions/ssl_certs" = ''
      ...
      # For the awos module: security.acme
