...
# IMPORTANT!
#
# https://github.com/awos/rfcs/blob/master/rfcs/0052-dynamic-ids.md
#
# Use of static ids is deprecated within awos. Dynamic allocation is
...
# awos pick dynamic persistent ids on activation. These IDs are persisted
...
in
{
  ...
  config = {
    ...
    ids.uids = {
      ...
      #
      # The reason behind this restriction is that, awos by default allocates
      ...
      # system user or group of the same id in someone else's awos.
      ...
      # [2]: <awos/modules/programs/shadow.nix>
      # [3]: https://github.com/awos/nixpkgs/commit/0e23a175de3687df8232fe118cbe87f04228ff28
