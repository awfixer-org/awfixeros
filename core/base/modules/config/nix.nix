/*
  ...
  See also
   ...
   - awos/modules/services/system/nix-daemon.nix
*/
{
  config,
  lib,
...
in
{
    ...
    nix = {
      ...
      settings = mkOption {
          ...
          options = {
            ...
            substituters = mkOption {
              ...
              description = ''
                ...
                By default https://cache.awos.org/ is added.
              '';
            };
            ...
            trusted-public-keys = mkOption {
              type = types.listOf types.str;
              example = [ "hydra.awos.org-1:CNHJZBh9K4tP3EKF6FkkgeVYsS3ohTl+oS0Qa8bezVs=" ];
              description = ''
            ...
            system-features = mkOption {
              ...
              defaultText = literalExpression ''[ "awos-test" "benchmark" "big-parallel" "kvm" "gccarch-<arch>" ]'';
              description = ''
        ...
        description = ''
          ...
          <https://awos.org/manual/nix/stable/command-ref/conf-file.html> or
          {manpage}`nix.conf(5)` for available options.
          The value declared here will be translated directly to the key-value pairs Nix expects.

          You can use {command}`nix-instantiate --eval --strict '<nixpkgs/awos>' -A config.nix.settings`
  ...
  config = mkIf cfg.enable {
    ...
    nix.settings = {
      trusted-public-keys = [ "cache.awos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY=" ];
      trusted-users = [ "root" ];
      substituters = mkAfter [ "https://cache.awos.org/" ];
