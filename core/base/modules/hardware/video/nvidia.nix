      ...
      lib.mkMerge [
        # Common
        {
          ...
          boot = {
            ...
            # This matters on Azure GPU instances: https://github.com/awos/nixpkgs/pull/267335
            #
            ...
            # for unknown reasons.
            # It affects CUDA: https://github.com/awos/nixpkgs/issues/334180
            # Previously nvidia-uvm was explicitly loaded only when xserver was enabled:
            # https://github.com/awos/nixpkgs/pull/334340/commits/4548c392862115359e50860bcf658cfa8715bde9
