...

{
  ...
  options = {
    ...
    networking.hostName = mkOption {
      default = config.system.awos.distroId;
      defaultText = literalExpression "config.system.awos.distroId";
      ...
      '';
      # warning until the issues in https://github.com/awos/nixpkgs/pull/138978
      # are resolved
    };
