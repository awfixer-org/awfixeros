# This module creates a bootable SD card image containing the given awos
...
in
{
  ...
  options.sdImage = {
    ...
    rootPartitionUUID = mkOption {
      ...
      description = ''
        UUID for the filesystem on the main awos partition on the SD card.
      '';
    };
    ...
    rootVolumeLabel = mkOption {
      type = types.str;
      default = "awos_SD";
      example = "awos_PENDRIVE";
      description = ''
        Label for the awos root volume.
        Usually used when creating a recovery awos media installation
    ...
    boot.postBootCommands =
      ...
      ''
        ...
        if [ -f ${nixPathRegistrationFile} ]; then
          ...
          # awos-rebuild also requires a "system" profile and an /etc/awos tag.
          touch /etc/awos
