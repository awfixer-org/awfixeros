# This module creates netboot media containing the given awos
# configuration.
...

{
  ...
  config = {
    ...
    boot.postBootCommands = ''
      ...
      # Set password for user awos if specified on cmdline
      # Allows using awos-anywhere in headless environments
      for o in $(</proc/cmdline); do
        case "$o" in
          live.awos.passwordHash=*)
            set -- $(IFS==; echo $o)
