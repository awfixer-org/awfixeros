      ...
      options = {
        ...
        login = {
          ...
          passwordFile = mkOption {
            ...
            example = "/etc/awos/dockerhub-password.txt";
          };
        ...
        ports = mkOption {
          ...
          description = ''
            ...
            Publishing a port bypasses the awos firewall. If the port is not
  ...
  mkService =
    ...
    in
    {
      ...
      serviceConfig = {
        ...
        ### systemd service from the perspective of the awos module system.
        ###
        # ExecReload = ...;
        ###
