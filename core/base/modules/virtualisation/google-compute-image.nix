...
let
  ...
  defaultConfigFile = pkgs.writeText "configuration.nix" ''
    ...
    {
      imports = [
        <nixpkgs/awos/modules/virtualisation/google-compute-image.nix>
      ];
    }
  '';
in
{
  ...
  options = {
    virtualisation.googleComputeImage.configFile = mkOption {
      ...
      default = null;
      description = ''
        A path to a configuration file which will be placed at `/etc/awos/configuration.nix`
  ...
  config = {
    ...
    system.awos.tags = [ "google-compute" ];
