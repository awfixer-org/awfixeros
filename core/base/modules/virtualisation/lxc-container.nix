  ...
  config =

    {
      ...
      boot.postBootCommands = ''
        ...
        # awos-rebuild also requires a "system" profile
      ...
      system.awos.tags = lib.mkOverride 99 [ "lxc" ];
      ...
      system.build.tarball = pkgs.callPackage ../../lib/make-system-tarball.nix {
        ...
        contents = [
          ...
          # awos will setup the same symlink after start.
          {
      ...
      system.build.squashfs = pkgs.callPackage ../../lib/make-squashfs.nix {
        fileName = "awos-lxc-image-${pkgs.stdenv.hostPlatform.system}";
