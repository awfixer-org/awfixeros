  ...
  options = {
    virtualbox = {
      ...
      vmDerivationName = lib.mkOption {
        type = lib.types.str;
        default = "awos-ova-${config.system.awos.label}-${pkgs.stdenv.hostPlatform.system}";
        description = ''
      ...
      vmName = lib.mkOption {
        type = lib.types.str;
        default = "${config.system.awos.distroName} ${config.system.awos.label} (${pkgs.stdenv.hostPlatform.system})";
        description = ''
