...

{
    ...
    boot = {
      ...
      efi = {
        path = mkOption {
          ...
          example = literalExpression "\${config.virtualisation.xen.package}/boot/efi/efi/awos/xen-\${config.virtualisation.xen.package.version}.efi";
          description = ''
            ...
            somewhere else, such as `$out/boot/efi/efi/awos/xen.efi`. Unless
  ...
  config = mkIf cfg.enable {
    ...
    boot = {
      ...
      # Xen Bootspec extension. This extension allows awos bootloaders to
    ...
    # All awos kernels come with this enabled by default; this is merely a sanity check.
