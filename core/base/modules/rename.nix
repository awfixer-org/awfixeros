...
in
{
  imports = [
    /*
      ...
      See https://github.com/awos/nixpkgs/pull/61570 for explanation
    */
    ...
    (mkRemovedOptionModule [ "boot" "loader" "raspberryPi" ]
      "The raspberryPi boot loader has been removed. See https://github.com/awos/nixpkgs/pull/241534 for what to use instead."
    )
    ...
    (mkRemovedOptionModule [ "programs" "yabar" ]
      "programs.yabar has been removed from awos. This is because the yabar repository has been archived upstream."
    )
    ...
    (mkRemovedOptionModule [ "services" "antennas" ]
      "The antennas package and the corresponding module have been removed as they only work with tvheadend, which nobody was willing to maintain and was stuck on an unmaintained version that required FFmpeg 4; please see https://github.com/awos/nixpkgs/pull/332259 if you are interested in maintaining a newer version."
    )
    (mkRemovedOptionModule [
      "services"
      "anbox"
    ...
    (mkRemovedOptionModule [ "services" "dnscrypt-wrapper" ] ''
      ...
      moreover the awos module had to rely on an abandoned version of dnscrypt-proxy v1 for the rotation of keys.
    ...
    (mkRemovedOptionModule [ "services" "matrix-sliding-sync" ]
      "The matrix-sliding-sync package has been removed, since matrix-synapse incorporated its functionality. Remove `services.sliding-sync` from your awos Configuration, and the `.well-known` record for `org.matrix.msc3575.proxy` from your webserver"
    )
    (mkRemovedOptionModule [
      "services"
      "mx-puppet-discord"
    ...
    (mkRemovedOptionModule [ "services" "morty" ]
      "services.morty has been removed from awos. As the morty package was unmaintained and removed and searxng, its main consumer, dropped support for it."
    )
    ...
    (mkRemovedOptionModule [ "services" "tvheadend" ]
      "The tvheadend package and the corresponding module have been removed as nobody was willing to maintain them and they were stuck on an unmaintained version that required FFmpeg 4; please see https://github.com/awos/nixpkgs/pull/332259 if you are interested in maintaining a newer version."
    )
    ...
    (mkRemovedOptionModule [ "services" "xserver" "displayManager" "auto" ] ''
      ...
      because it was only intended for use in internal awos tests, and gave the
      ...
      instead, or any other display manager in awos as they all support auto-login.
    '')
    (mkRemovedOptionModule [
      "services"
      "xserver"
    ...
    (mkRemovedOptionModule [ "services" "rtsp-simple-server" ]
      "Package has been completely rebranded by upstream as mediamtx, and thus the service and the package were renamed in awos as well."
    )
    (mkRemovedOptionModule [
      "services"
      "prayer"
    ...
    (mkRemovedOptionModule [ "services" "conduwuit" ] ''
      ...
      See https://github.com/awos/nixpkgs/pull/397902 for more information.
    '')
    ...
    (mkRemovedOptionModule [ "virtualisation" "lxd" ] ''
      LXD has been removed from awos due to lack of Nixpkgs maintenance.
