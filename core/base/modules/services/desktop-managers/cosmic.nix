...
# Portions of this code are adapted from awos-cosmic
# https://github.com/lilyinstarlight/awos-cosmic
  ...
  config = lib.mkIf cfg.enable {
    ...
    warnings = lib.optionals (cfg.showExcludedPkgsWarning && excludedCorePkgs != [ ]) [
      ''
        ...
        exclude non-essential packages, please look at the awos module for the
