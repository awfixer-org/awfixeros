        ...
        profiles.user.databases = [
          {
            settings = {
              "com/lomiri/shell/launcher" = {
                logo-picture-uri = "file://${pkgs.awos-icons}/share/icons/hicolor/scalable/apps/nix-snowflake-white.svg";
      ...
      environment = {
        systemPackages =
          ...
          ++ (with pkgs.lomiri; [
            ...
            # Qt5 qtwebengine is not secure: https://github.com/awos/nixpkgs/pull/435067
            # morph-browser
