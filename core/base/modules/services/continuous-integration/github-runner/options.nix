          ...
          options = {
            ...
            url = lib.mkOption {
              ...
              description = ''
                ...
                `https://github.com/awos`, not like this
                `https://github.com/awos/nixpkgs`.
                Otherwise, you are going to get a `404 NotFound`
                from `POST https://api.github.com/actions/runner-registration`
                in the configure script.
              '';
              example = "https://github.com/awos/nixpkgs";
            };
            ...
            tokenFile = lib.mkOption {
              ...
              '';
              example = "/run/secrets/github-runner/awos.token";
            };
            ...
            extraLabels = lib.mkOption {
              ...
              description = ''
                ...
                Changing this option triggers a new runner registration.
              '';
              example = lib.literalExpression ''[ "awos" ]'';
              default = [ ];
            };
