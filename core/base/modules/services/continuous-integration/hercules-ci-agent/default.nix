/*
  This file is for awos-specific options and configs.
    ...
    services.hercules-ci-agent = {
      settings = {
        ...
        labels =
          ...
          in
          {
            awos.configurationRevision = mkIfNotNull config.system.configurationRevision;
            awos.release = config.system.awos.release;
            awos.label = mkIfNotNull config.system.awos.label;
            awos.codeName = config.system.awos.codeName;
            awos.tags = config.system.awos.tags;
            awos.systemName = mkIfNotNull config.system.name;
          };
      };
    };
