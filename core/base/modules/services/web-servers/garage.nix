...
in
{
  ...
  options.services.garage = {
    ...
    package = mkOption {
      type = types.package;
      description = "Garage package to use, needs to be set explicitly. If you are upgrading from a major version, please read awos and Garage release notes for upgrade instructions.";
    };
  };
