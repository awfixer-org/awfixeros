        ...
        submodule (
          ...
          in
          {
            options = {
              ...
              ui.enable = mkOption {
                type = bool;
                default = awosConfig.services.netbird.ui.enable;
              ...
              config = mkOption {
                ...
                description = ''
                  ...
                  This option manages specifically `50-awos.json` file.
  ...
  config = mkMerge [
    ...
    })
    {
      ...
      environment.etc = toClientAttrs (
        client:
        nameValuePair "${client.dir.baseName}/config.d/50-awos.json" {
