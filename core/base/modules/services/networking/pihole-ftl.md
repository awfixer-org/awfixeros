...
Note that in awos the script has been patched to remove the reinstallation,
update, and Dnsmasq configuration commands. In awos, Pi-hole's configuration is
immutable and must be done with awos options.
