...
let
  ...
  */
  ...
  yesNoOption = awosName: vsftpdName: default: description: {
    cfgText = "${vsftpdName}=${if getAttr awosName cfg then "YES" else "NO"}";
...

{
  ...
  options = {
    ...
    // (listToAttrs (catAttrs "awosOption" optionDescription));
