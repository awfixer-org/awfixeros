  ...
  options.services.pdns-recursor = {
    ...
    old-settings = mkOption {
      ...
      description = ''
        ...
        Recursor settings not exposed in a awos option or to bypass one.
        ...
        and will be removed in the next release of awos.
        :::
      '';
    };
    ...
    yaml-settings = mkOption {
      ...
      description = ''
        ...
        settings not exposed in a awos option or to bypass one.
        See the full documentation at
