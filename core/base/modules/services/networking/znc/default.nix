    ...
    services.znc = {
      ...
      config = mkOption {
        ...
        description = ''
          ...
          You can use {command}`nix-instantiate --eval --strict '<nixpkgs/awos>' -A config.services.znc.config`
      ...
      mutable = mkOption {
        ...
        description = ''
          ...
          creation are not overwritten by a awos rebuild. If disabled, the
          ZNC configuration is rebuilt on every awos rebuild.
