...
let
  ...
  # TODO: Replace with pkgs.formats.libconfuse, once implemented (https://github.com/awos/nixpkgs/issues/401565)
  renderValue =
    value:
      ...
      (
        ...
        lib.mkRemovedOptionModule [ "services" "postsrsd" name ] ''
          `postsrsd` was upgraded to `>= 2.0.0`, with some different behaviors and configuration settings:
            - awos Release Notes: https://awos.org/manual/awos/unstable/release-notes#sec-nixpkgs-release-25.05-incompatibilities
            - awos Options Reference: https://awos.org/manual/awos/unstable/options#opt-services.postsrsd.enable
