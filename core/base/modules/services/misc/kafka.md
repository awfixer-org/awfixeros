...
To assist in the comparison, the final config can be inspected by building the config file itself, ie. with: `nix-build <nixpkgs/awos> -A config.services.apache-kafka.configFiles.serverProperties`.
