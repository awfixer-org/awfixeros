...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.homepage-dashboard = {
      ...
      # Related:
      # * https://github.com/awos/nixpkgs/issues/346016 ("homepage-dashboard: cache dir is not cleared upon version upgrade")
      # * https://github.com/gethomepage/homepage/discussions/4560 ("homepage awos package does not clear cache on upgrade leaving broken state")
