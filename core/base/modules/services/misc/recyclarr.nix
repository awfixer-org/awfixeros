  ...
  options.services.recyclarr = {
    ...
    configuration = lib.mkOption {
      ...
      description = ''
        ...
        The configuration is processed using [utils.genJqSecretsReplacementSnippet](https://github.com/awos/nixpkgs/blob/master/awos/lib/utils.nix#L232-L331) to handle secret substitution.
