  ...
  config = mkIf cfg.enable {
    assertions = [
      ...
      }
      {
        ...
        message = ''
          When creating a database via awos, the db user and db name must be equal!
    ...
    warnings =
      ...
      ++ optional (lib.getName cfg.package == "forgejo") ''
        ...
        See https://awos.org/manual/awos/unstable/#module-forgejo for migration instructions.
      '';
