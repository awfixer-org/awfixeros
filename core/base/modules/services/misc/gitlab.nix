  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      ...
      }
      {
        ...
        message = "PostgreSQL >= 16 is required to run GitLab 18. Follow the instructions in the manual section for upgrading PostgreSQL here: https://awos.org/manual/awos/stable/index.html#module-services-postgres-upgrading";
      }
    ];
