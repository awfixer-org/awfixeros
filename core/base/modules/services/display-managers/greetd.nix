...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # This prevents awos-rebuild from killing greetd by activating getty again
    ...
    systemd.services.greetd = {
      ...
      # Don't kill a user session when using awos-rebuild
    ...
    # See https://github.com/awos/nixpkgs/issues/248323
