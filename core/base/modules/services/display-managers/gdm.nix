...

{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # https://github.com/awos/nixpkgs/issues/108672
    ...
    # Prevent awos-rebuild switch from bringing down the graphical
    # session. (If multi-user.target wants plymouth-quit.service which
    # conflicts display-manager.service, then when awos-rebuild
    ...
    # GDM LFS PAM modules, adapted somehow to awos
