...
in
{
  options = {
    services.mautrix-discord = {
      ...
      # TODO: Get upstream to add an environment File option. Refer to https://github.com/awos/nixpkgs/pull/404871#issuecomment-2895663652 and https://github.com/mautrix/discord/issues/187
