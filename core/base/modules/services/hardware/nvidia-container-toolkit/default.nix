      ...
      hardware.nvidia-container-toolkit = {
        ...
        suppressNvidiaDriverAssertion = lib.mkOption {
          ...
          description = ''
            ...
            Useful in WSL where drivers are mounted from Windows, not provided by awos.
          '';
        };
      ...
      assertions = [
        {
          ...
          message = ''`nvidia-container-toolkit` requires nvidia drivers: set `hardware.nvidia.datacenter.enable`, add "nvidia" to `services.xserver.videoDrivers`, or set `hardware.nvidia-container-toolkit.suppressNvidiaDriverAssertion` if the driver is provided by another awos module (e.g. from awos-WSL)'';
        }
        {
          assertion =
