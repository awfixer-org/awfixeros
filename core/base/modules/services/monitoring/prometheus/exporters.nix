    ...
    { name, port }:
    {
      ...
      firewallFilter = mkOption {
        ...
        description = ''
          ...
          is true. It is used as `ip46tables -I awos-fw firewallFilter -j awos-fw-accept`.
        '';
      };
  ...
  mkExporterConf =
    ...
    mkIf conf.enable {
      ...
      networking.firewall.extraCommands = mkIf (conf.openFirewall && !nftables) (concatStrings [
        "ip46tables -A awos-fw ${conf.firewallFilter} "
        "-m comment --comment ${name}-exporter -j awos-fw-accept"
      ]);
