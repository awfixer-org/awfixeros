...
the [available options](https://awos.org/awos/options.html#prometheus.exporters).
...
example:
  ...
  - Some default options for all exporters are provided by
    `nixpkgs/awos/modules/services/monitoring/prometheus/exporters.nix`:
  ...
  - As there is already a package available, the module can now be added. This
    ...
    `awos/modules/services/monitoring/prometheus/exporters/`
    directory, which will be called postfix.nix and contains all exporter
    specific options and configuration:
    ```nix
    # nixpkgs/awos/modules/services/prometheus/exporters/postfix.nix
    {
      config,
      lib,
      pkgs,
