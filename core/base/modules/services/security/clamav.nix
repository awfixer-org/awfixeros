      ...
      scanner = {
        ...
        scanDirectories = lib.mkOption {
          ...
          description = ''
            ...
            The default includes everything I could think of that is valid for awos. Feel free to contribute a PR to add to the default if you see something missing.
          '';
        };
      };
    };
