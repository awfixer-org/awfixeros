...
let
  ...
  drupalSettings =
    hostName: cfg:
    pkgs.writeTextFile {
      name = "settings.awos-${hostName}.php";
      text = ''
        <?php

          // awos automatically generated settings
  ...
  appendSettings =
    ...
    pkgs.writeTextFile {
      ...
      text = ''
        ...
        // awos settings file import.
        require dirname(__FILE__) . '/settings.awos-${hostName}.php';
          ...
          (nameValuePair "drupal-state-init-${hostName}" {
            ...
            serviceConfig = {
              ...
              ExecStart = writeShellScript "drupal-state-init-${hostName}" ''
                ...
                # Link the awos-managed settings file to the state directory.
                ln -sf ${drupalSettings hostName cfg} ${cfg.stateDir}/sites/default/settings.awos-${hostName}.php
