  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      # there are several challenges with dolibarr and awos which we can address here
      ...
      systemd.services.dolibarr-config = {
        description = "dolibarr configuration file management via awos";
        ...
        script =
          ...
          in
          ''
            # extract the 'main instance unique id' secret that the dolibarr installer generated for us, store it in a file for use by our own awos generated configuration file
            ...
            # replace configuration file generated by installer with the awos generated configuration file
