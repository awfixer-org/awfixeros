      ...
      if lib.versionAtLeast config.system.stateVersion "23.11" then
        ...
        throw ''
            ...
            snippet should work:
                ...
                services.pict-rs.package =
                  (import (builtins.fetchTarball {
                    url = "https://github.com/awos/nixpkgs/archive/9b19f5e77dd906cb52dade0b7bd280339d2a1f3d.tar.gz";
          ...
          * <https://git.asonix.dog/asonix/pict-rs/src/tag/v0.5.16#0-4-to-0-5-migration-guide>
          ...
          The awos module will handle the configuration changes for you,
          at least.
        ''
    );
