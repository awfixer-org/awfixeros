...
The current default by awos is `nextcloud32` which is also the latest
...
## Common problems {#module-services-nextcloud-pitfalls-during-upgrade}
  ...
  - **Multiple version upgrades.**
    ...
    the oldest version available (one major behind the one from the previous awos
  ...
  - **`Error: Command "upgrade" is not defined.`**
    ...
    be found in [awos/nixpkgs#111175](https://github.com/awos/nixpkgs/issues/111175).
