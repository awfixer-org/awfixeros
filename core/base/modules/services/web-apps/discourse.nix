    ...
    services.discourse = {
      ...
      siteSettings = lib.mkOption {
        ...
        description = ''
          ...
          {file}`config/awos_site_settings.json` file,
    ...
    assertions = [
      ...
      }
      {
        ...
        message =
          ...
          + "See https://awos.org/manual/awos/stable/index.html#module-postgresql for details on how to upgrade PostgreSQL.";
      }
    ];
      ...
      preStart =
        ...
        ''
          ...
          (
              ...
              ${utils.genJqSecretsReplacementSnippet cfg.siteSettings "/run/discourse/config/awos_site_settings.json"}
