  ...
  options = {
    services.nextjs-ollama-llm-ui = {
      enable = lib.mkEnableOption ''
        ...
        You can host such a backend service with awos through "services.ollama".
      '';
      ...
      hostname = lib.mkOption {
        ...
        description = ''
          ...
          See <https://wiki.awos.org/wiki/Nginx> for instructions on how to set up a reverse-proxy.
        '';
      };
