...
let
  ...
  awosSpec = calendarSettingsFormat.generate "awos_specification.json" cfg.calendarSettings;
  finalPackage = cfg.package.override {
    ...
    defaultSpecificationFile = pkgs.runCommand "custom-default_specification.yml" { } ''
      ${pkgs.yq}/bin/yq -s '.[0] * .[1]' ${cfg.package}/${cfg.package.defaultSpecificationPath} ${awosSpec} > $out
    '';
  };
