...
in
{
  ...
  options = {
    ...
    services.xserver.displayManager.lightdm = {
      ...
      background = mkOption {
        ...
        defaultText = literalExpression "pkgs.awos-artwork.wallpapers.simple-dark-gray-bottom.gnomeFilePath";
        description = ''
  ...
  config = mkIf cfg.enable {
    ...
    services.xserver.displayManager.lightdm.background =
      mkDefault pkgs.awos-artwork.wallpapers.simple-dark-gray-bottom.gnomeFilePath;
