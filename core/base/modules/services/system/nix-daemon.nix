/*
  ...
  See also
   - awos/modules/config/nix.nix: the nix.conf
   - awos/modules/config/nix-remote-build.nix: the nix.conf
*/
{
  config,
  lib,
    ...
    nix = {
      ...
      enable = lib.mkOption {
        ...
        description = ''
          ...
          Disabling Nix makes the system hard to modify and the Nix programs and configuration will not be made available by awos itself.
        '';
      };
