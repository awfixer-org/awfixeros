      ...
      { ... }:
      {
        ...
        services.syncoid = {
          ...
          commands = {
            ...
            # Test pool without parent (regression test for https://github.com/awos/nixpkgs/pull/180111)
            "pool".target = "root@target:pool/full-pool";

            # Test backward compatible options (regression test for https://github.com/awos/nixpkgs/issues/181561)
            "pool/compat" = {
