    ...
    makeTest {
      ...
      testScript = ''
        ...
        with subtest("Check whether the channel got installed correctly"):
            ...
            machine.succeed("nix-env --dry-run -iA awos.procps")
  ...
  makeNetbootTest =
        ...
        (import ../lib/eval-config.nix {
          ...
          modules = [
            ...
            ../modules/testing/test-instrumentation.nix
            {
              boot.kernelParams = [
                "serial"
                "live.awos.passwordHash=$6$jnwR50SkbLYEq/Vp$wmggwioAkfmwuYqd5hIfatZWS/bO6hewzNIwIrWcgdh7k/fhUzZT29Vil3ioMo94sdji/nipbzwEpxecLZw0d0" # "password"
              ];
    ...
    makeTest {
      ...
      testScript = ''
        ...
        machine.succeed("grep 'live.awos.passwordHash' /proc/cmdline")
