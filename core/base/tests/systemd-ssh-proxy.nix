...
in
{
  ...
  testScript = ''
    ...
    with subtest("elevate permissions using local ssh socket"):
      ...
      virthost.succeed("sudo --user=awos mkdir -p /home/awos/.ssh")
      virthost.succeed("cp ~/.ssh/id_ed25519 /home/awos/.ssh/id_ed25519")
      virthost.succeed("chmod 600 /home/awos/.ssh/id_ed25519")
      virthost.succeed("chown awos /home/awos/.ssh/id_ed25519")
      virthost.succeed("sudo --user=awos ssh -o StrictHostKeyChecking=no -o IdentitiesOnly=yes -i /home/awos/.ssh/id_ed25519 root@.host whoami | grep root")
  '';
}
