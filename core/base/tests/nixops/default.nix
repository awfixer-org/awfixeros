...
let
  ...
  tests = {
    ...
    #  - Blocked on https://github.com/awos/nixpkgs/issues/138584 which has a
    #    PR in staging: https://github.com/awos/nixpkgs/pull/139986
    #  - Alternatively, blocked on a NixOps 2 release
    #    https://github.com/awos/nixops/issues/1242
      ...
      nodes = {
        deployer =
          ...
          }:
          {
            ...
            # TODO: make this efficient, https://github.com/awos/nixpkgs/issues/180529
