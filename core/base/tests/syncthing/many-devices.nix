...
# This awosTest is supposed to check the following:
#
# - Whether syncthing's API handles multiple requests for many devices, see
#   https://github.com/awos/nixpkgs/issues/260262
#
...
#   https://github.com/awos/nixpkgs/issues/259256
#
...
let
  ...
  IDsToDelete = {
    ...
    # explained in: https://github.com/awos/nixpkgs/issues/259256
    folder = "DeleteMe";
  };
