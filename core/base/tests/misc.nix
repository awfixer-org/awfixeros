...
in
{
  ...
  nodes.machine =
    { lib, ... }:
    {
      ...
      virtualisation.fileSystems = {
        ...
        # Tests https://discourse.awos.org/t/how-to-make-a-derivations-executables-have-the-s-permission/8555
        "/user-mount/point" = {
  ...
  testScript = ''
    with subtest("awos-version"):
        machine.succeed("[ `awos-version | wc -w` = 2 ]")

    with subtest("awos-rebuild"):
        assert "awos module" in machine.succeed("awos-rebuild --help")
