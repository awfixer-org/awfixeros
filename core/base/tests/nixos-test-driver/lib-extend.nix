...
let
  ...
  inherit (patchedPkgs.testers) awosTest runawosTest;
  evaluationawosTest = awosTest testBody;
  evaluationRunawosTest = runawosTest testBody;
in
{
  awosTest = evaluationawosTest.driver.nodes.machine.system.build.toplevel;
  runawosTest = evaluationRunawosTest.driver.nodes.machine.system.build.toplevel;
}
