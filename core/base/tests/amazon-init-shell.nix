...
# exits.
# Note that other tests verify that amazon-init can treat user-data as a awos
  ...
  nodes.machine = {
    ...
    environment.etc."ec2-metadata/user-data" = {
      text = ''
        ...
        # Emulate running awos-rebuild switch, just without any building.
        # https://github.com/awos/nixpkgs/blob/4c62505847d88f16df11eff3c81bf9a453a4979e/awos/modules/virtualisation/amazon-init.nix#L55
