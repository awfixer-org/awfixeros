import ./make-test-python.nix (
  ...
  let
    ...
    # /etc/awos/configuration.nix for the vm
  ...
  in
  {
    ...
    nodes.machine =
      ...
      (
        ...
        // {
          ...
          # awos-rebuild needs must be included in the VM.
          system.extraDependencies = with pkgs; [
            ...
            docbook_xsl_ns
            grub2
            awos-artwork.wallpapers.simple-dark-gray-bootloader
    ...
    testScript = ''
      ...
      machine.succeed("awos-rebuild boot --show-trace >&2")
